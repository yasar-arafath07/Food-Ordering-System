...
void account_check()
{
	...
	// one with new inputs
	if (i == 100) {
		strcpy_s(s[j].uname, temp_name);
		s[j].age = temp_age;
		strcpy_s(s[j].password, temp_password1);
		strcpy_s(s[j].email, temp_email);
		strcpy_s(s[j].mobile, temp_mobile);
		j++;
...
void hotel_initialize()
{
	...
	strcpy_s(m[1].hotel, "Aarya_Bhavan");
	strcpy_s(m[1].first_food, "Sandwich");
	strcpy_s(m[1].second_food, "Pizza");
	strcpy_s(m[1].third_food, "Fried_Rice");
	m[1].first = 70;
	m[1].second = 100;
	m[1].third = 95;
	...
	strcpy_s(m[2].hotel, "Banu_Hotel");
	strcpy_s(m[2].first_food, "Parotta");
	strcpy_s(m[2].second_food, "Noodles");
	strcpy_s(m[2].third_food, "Chicken_Rice");
	m[2].first = 15;
	m[2].second = 75;
	m[2].third = 80;
	...
	strcpy_s(m[3].hotel, "SR_Bhavan");
	strcpy_s(m[3].first_food, "Chicken_Biriyani");
	strcpy_s(m[3].second_food, "Prawn");
	strcpy_s(m[3].third_food, "Faloda");
	m[3].first = 90;
	m[3].second = 120;
	m[3].third = 35;
}
